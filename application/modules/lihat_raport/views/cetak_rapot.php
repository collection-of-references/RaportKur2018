...
<body>
	...
	<table>
		...
		<tr>
			<td width="20%">Nama Sekolah</td><td width="1%">:</td><td width="39%" class="tbl">SMK X</td>
			<td width="20%">Kelas</td><td width="1%">:</td><td width="19%" class="tbl"><?php echo strtoupper($wali_kelas['nama_kelas']); ?></td>
		</tr>
		<tr>
			<td>Alamat Sekolah</td><td>:</td><td class="tbl">Kota X</td>
			...
			<td colspan="6">
				...
				<table width="100%">
					<tr>
						...
						<td width="10%"></td>
						<td width="30%">
							Kota X, <?php echo $this->config->item('tgl_cetak'); ?><br>
							Kepala SMK X <br>
							<br><br><br><br>
							<u><b>Mr. X</b></u><br>
							NIP. xxxxx
